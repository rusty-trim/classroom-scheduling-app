    ...
    , ui(new Ui::HelpDialog)
{
    ...
    if (mainLayout) {
        ...
        // Re-add only the widgets we want in the order we want
    ...
    // ---- FORCE EACH TAB PAGE LAYOUT TOO ----
    ...
    scheduleText += "<ol>";
    scheduleText += "<li>Use the week arrows or the drop down arrow next to the current selected date to open the calender selection option.</li>";
    ...
    popupText += "<li><b>Conflict warning:</b> another reservation already exists in that time slot.</li>";
