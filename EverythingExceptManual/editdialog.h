...
public:
    ...
    void setAvailableRooms(const QStringList &rooms, const QString &currentRoom);
    void setReservationData(const QString &name, const QString &room, const QDate &date,
